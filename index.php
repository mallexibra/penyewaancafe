...
<body class="font-poppins bg-stone-400">
  ...
  <header class="w-full min-h-[300px] bg-[url('/src/assets/image/cafe.jpg')]">
      ...
      <div class="containers flex justify-center items-center flex-col">
        <div class="header-items">
          ...
          <div class="cta flex items-center justify-center pt-8">
            <a href="users/produk.html" class="flex gap-2 text-stone-800 font-bold border border-yellow-400 bg-yellow-500 hover:bg-yellow-400 transition-all duration-300 focus:ring-4 focus:ring-stone-300 rounded-lg text-sm px-7 py-4 mr-2 mb-2 focus:outline-none">Pesan Sekarang <img src="src/assets/icons/arrow-r.png" alt="" /></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <main class="containers">
    <section class="my-12">
      <h1 class="text-center text-stone-800 text-2xl pb-4 font-bold">
        Tentang Kami
      </h1>
      <div class="items-wrap flex gap-3">
        <div class="line w-4 bg-yellow-400 rounded-md"></div>
        <p class="text-left text-sm max-w-xl md:text-lg">
        ...
        <div class="bg-[url('/src/assets/image/coffeebean.png')] bg-cover w-full"></div>
      </div>
    </section>
    ...
    <div class="serve-items flex flex-col md:flex-row justify-center gap-8">
      <div class="serve-item flex items-center flex-col gap-4">
        <div class="flex items-center justify-center card w-16 h-16 bg-stone-300 text-lg font-bold rounded-full text-center">
          1
        </div>
    ...
    <div class="question-accordion my-12">
      <h1 class="text-center text-stone-800 text-2xl pb-4 font-bold">
        Kenapa Pilih Kami?
      </h1>
      <div id="accordion-open" data-accordion="open">
        <h2 id="accordion-open-heading-1">
          <button type="button" class="flex rounded-t-md items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-b-0 border-gray-200 focus:ring-4 bg-stone-700" data-accordion-target="#accordion-open-body-1" aria-expanded="false" aria-controls="accordion-open-body-1">
            <span class="flex items-center text-white"> Lorem? </span>
        ...
        <div id="accordion-open-body-1" class="hidden" aria-labelledby="accordion-open-heading-1">
          <div class="p-5 border border-b-0 bg-stone-500 border-gray-200">
            <p class="text-white">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
        ...
        <div id="accordion-open-body-2" class="hidden" aria-labelledby="accordion-open-heading-2">
          <div class="p-5 border border-b-0 border-gray-200 bg-stone-500">
            <p class="text-white">
        ...
        <div id="accordion-open-body-3" class="hidden" aria-labelledby="accordion-open-heading-3">
          <div class="p-5 border border-t-0 bg-stone-500">
            <p class="text-white">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit.
  ...
  <footer class="bottom-0 bg-stone-700">
    <section class="footer-items p-6 flex items-center flex-col gap-5">
      ...
      <div class="sosmed-icons flex gap-5">
        <div class="sosmed-items bg-stone-500 w-10 h-10 flex items-center justify-center rounded-full">
          <a href="">
